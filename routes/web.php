...
// --- DASHBOARD (Hapus Route '/' yang duplikat di bawah sini) ---
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('/add/video/{course_ide}', [CourseVideoController::class, 'create'])
    ->middleware('role:teacher|owner')
    ->name('course.add_video');

Route::post('/add/video/save/{course_ide}', [CourseVideoController::class, 'store'])
    ->middleware('role:teacher|owner')
